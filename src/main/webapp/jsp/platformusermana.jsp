					...
					<div class="layui-tab-item layui-show" >
						<div class="admin-main fadeInUp animated">
							...
							<fieldset class="layui-elem-field">
								<legend>平台用户列表</legend>
								<div class="layui-field-box">
									<table class="layui-hide" id="test" lay-filter="test"></table>
									<script type="text/html" id="toolbarDemo">
  										<div class="layui-btn-container">
   											 <button class="layui-btn layui-btn-sm" lay-event="addplatformuser">添加</button>
  										</div>
									</script>
												...
												.use(
														...
														function() {
															...
															table.on('toolbar(test)',function(obj){
																switch(obj.event){
																case 'addplatformuser':
																	layer.open({
																		type: 2,
																        title: '新增',
																        area : ['600px' , '600px'], 
																        scrollbar: false,//禁止浏览器滚动
																        content: 'platformuserinsert.jsp',
																        end:function(){
																        		table.reload('suserlist',{where : {}});
																        }
																	});
																	break;
																}
															...
															table.on('tool(test)',function(obj) {
																...
																layer.open({
															        ...
															        area : ['600px' , '600px'], 
															        scrollbar: false,//禁止浏览器滚动
															        content: 'platformuserdetail.jsp?'+data.id,
															        end:function(){
															        		table.reload('suserlist',{where : {}});
															        }
																});
